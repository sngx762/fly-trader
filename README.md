...
```text
FlyA: +17.24%, WinRate 55.8%, сделок 163 (Побед 91, Поражений 72), Пик: $120.23
FlyB: +17.15%, WinRate 55.8%, сделок 163 (Побед 91, Поражений 72), Пик: $120.23
```

### XAUUSD (Twelve Data, 1h, 5000 свечей)
```text
FlyA: -8.49%, WinRate 51.2%, сделок 209 (Побед 107, Поражений 102), Пик: $109.05
FlyB: -8.39%, WinRate 50.9%, сделок 212 (Побед 108, Поражений 104), Пик: $108.87
```

> ⚠️ **XAU не поддаётся на текущих hyperparams:** На глубоком интервале в 5000 свечей золото демонстрирует устойчивые многомесячные тренды, в то время как спайковый агент с оконным z-score и обучением с нуля совершает частые контртрендовые сделки. Это честный результат для неадаптированной под макро-тренды сырьевых рынков нейроархитектуры мухи.
